...
--
-- Temporary table structure for view `pilotoconequipo`
--

DROP TABLE IF EXISTS `pilotoconequipo`;
/*!50001 DROP VIEW IF EXISTS `pilotoconequipo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `pilotoconequipo` (
  `idPiloto` int(11),
  `Nombre` varchar(45),
  `Fotografía` varchar(45),
  `equipo_id` int(11),
  `idEquipo` int(11),
  `Equipo` varchar(45),
  `Vehículo` varchar(45)
...
--
-- Final view structure for view `pilotoconequipo`
--

/*!50001 DROP TABLE IF EXISTS `pilotoconequipo`*/;
/*!50001 DROP VIEW IF EXISTS `pilotoconequipo`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pilotoconequipo` AS select `piloto`.`id` AS `idPiloto`,`piloto`.`nombre` AS `Nombre`,`piloto`.`foto` AS `Fotografía`,`piloto`.`equipo_id` AS `equipo_id`,`equipo`.`id` AS `idEquipo`,`equipo`.`nombre` AS `Equipo`,`equipo`.`vehiculo` AS `Vehículo` from (`piloto` join `equipo`) where (`piloto`.`equipo_id` = `equipo`.`id`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2011-10-04  5:13:27
